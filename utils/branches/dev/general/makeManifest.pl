...
my $VERSION = sprintf "%d.%03d", q$Revision: 284044 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 284044 $
   # \RCS$Date: 2015-04-10 12:38:37 +0200 (Fri, 10 Apr 2015) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/branches/dev/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 284044 2015-04-10 10:38:37Z alverson $
